...
document.getElementById("crearcuenta").addEventListener("click", function(event) {
    ...
    const aIngresado = document.querySelector("input[name='apellido']").value;
    const coIngresado = document.querySelector("input[name='correoelectronico']").value;
    const cIngresado = document.querySelector("input[name='contrasena']").value;
